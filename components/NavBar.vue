<template>
  <div class="fixed flex items-center h-14 w-full bg-zinc-100 dark:bg-zinc-900 px-12">
    ...
    <div class="space-x-4 text-lg ml-4">
      <NuxtLink to="/developer-localization-project" class="nav-button">
        开发者汉化计划
      </NuxtLink>
    </div>
    <div class="flex-auto">
    ...
    <div class="flex items-center space-x-4 text-lg">
      <NuxtLink href="https://docs.vrczh.org" target="_blank" class="nav-button">VRChat
        汉化文档中心</NuxtLink>
      <NuxtLink href="https://vcc.vrczh.org/" target="_blank" class="nav-button">VPM 镜像站
      </NuxtLink>
