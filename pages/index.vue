                ...
                <div class="flex mt-60 space-x-4">
                    <InfoCard class="flex-1" title="公告 📢">
                        <p>VPM镜像库现已发布！<br />
                            ...
                            <br />
                            我们也希望更多的国内创作者能够通过此镜像库发挥出更加惊人的创作力和创作热情！
                        </p>
                    </InfoCard>
            ...
            <div class="space-y-6">
                <InfoCard title="简介📖">
                    <p>
                        ...
                        <br />
                        与此同时，VRCD 也提供与众不同的，精彩的创作者活动和资讯，例如来自 VRChat 官方的最新资讯和活动，您也可以在这里参与汉化相关的活动，如 VRChat 开发者汉化，VR 文档汉化等，让您可以为
                        VR
                        的中文化做出贡献，以享受更多的 VR 内容。
                        <br />
